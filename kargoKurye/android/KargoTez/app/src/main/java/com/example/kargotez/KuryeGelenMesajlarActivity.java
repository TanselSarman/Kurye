...
public class KuryeGelenMesajlarActivity extends AppCompatActivity {

    ListView kurye_gelen_mesajlar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kurye_gelen_mesajlar);
        kurye_gelen_mesajlar=findViewById(R.id.kurye_gelen_mesajlar);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            kurye_gelen_mesajlar.setAdapter(adapter);
        ...
        kurye_gelen_mesajlar.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {

                Intent intent=new Intent(getApplicationContext(),KuryeGelenMesajlarDetayActivity.class);
