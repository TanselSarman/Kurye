...
public class MusteriGelenKargolarımListe extends AppCompatActivity {

    ListView kargo_gelenler;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_musteri_gelen_kargolarim_liste);
        kargo_gelenler=findViewById(R.id.kargo_gelenler);
        listeGetir();
    ...
    private void listeGetir(){
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            kargo_gelenler.setAdapter(adapter);
        ...
        kargo_gelenler.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {

                Intent intent=new Intent(getApplicationContext(),MusteriGelenKargolarımDetay.class);
